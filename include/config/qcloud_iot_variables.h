...
#ifndef QCLOUD_IOT_HUB_SDK_EMBEDDED_C_INCLUDE_CONFIG_QCLOUD_IOT_VARIABLES_H_
#define QCLOUD_IOT_HUB_SDK_EMBEDDED_C_INCLUDE_CONFIG_QCLOUD_IOT_VARIABLES_H_
...
/**
 * @brief MAX size of log buffer for one log item including header and content
 *
 */
...
#endif  // QCLOUD_IOT_HUB_SDK_EMBEDDED_C_INCLUDE_CONFIG_QCLOUD_IOT_VARIABLES_H_
