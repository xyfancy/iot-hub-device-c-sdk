...
#ifndef QCLOUD_IOT_HUB_SDK_EMBEDDED_C_INCLUDE_CONFIG_QCLOUD_IOT_CONFIG_H_
#define QCLOUD_IOT_HUB_SDK_EMBEDDED_C_INCLUDE_CONFIG_QCLOUD_IOT_CONFIG_H_
...
#endif  // QCLOUD_IOT_HUB_SDK_EMBEDDED_C_INCLUDE_CONFIG_QCLOUD_IOT_CONFIG_H_
