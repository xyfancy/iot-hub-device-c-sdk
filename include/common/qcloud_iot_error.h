...
#ifndef QCLOUD_IOT_HUB_SDK_EMBEDDED_C_INCLUDE_COMMON_QCLOUD_IOT_ERROR_H_
#define QCLOUD_IOT_HUB_SDK_EMBEDDED_C_INCLUDE_COMMON_QCLOUD_IOT_ERROR_H_
...
#endif  // QCLOUD_IOT_HUB_SDK_EMBEDDED_C_INCLUDE_COMMON_QCLOUD_IOT_ERROR_H_
