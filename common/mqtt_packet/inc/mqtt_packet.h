...
#ifndef QCLOUD_IOT_HUB_SDK_EMBEDDED_C_COMMON_MQTT_PACKET_INC_MQTT_PACKET_H_
#define QCLOUD_IOT_HUB_SDK_EMBEDDED_C_COMMON_MQTT_PACKET_INC_MQTT_PACKET_H_
...
#endif  // QCLOUD_IOT_HUB_SDK_EMBEDDED_C_COMMON_MQTT_PACKET_INC_MQTT_PACKET_H_
